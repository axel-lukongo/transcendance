...
let UserController = class UserController {
    ...
    async updateUserAvatarImg(id, { avatar }) {
...
__decorate([
    (0, common_1.Patch)(':id/token'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "updateUserToken", null);
__decorate([
    (0, common_1.Patch)(':id/nickname'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "updateUserNickname", null);
__decorate([
    (0, common_1.Patch)(':id/nickname'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    ...
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "updateUserAvatarImg", null);
