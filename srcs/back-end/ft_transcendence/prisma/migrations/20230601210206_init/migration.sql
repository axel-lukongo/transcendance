...
-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_user_receiver_id_fkey" FOREIGN KEY ("user_receiver_id") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_chan_receiver_id_fkey" FOREIGN KEY ("chan_receiver_id") REFERENCES "Chanel"("id") ON DELETE SET NULL ON UPDATE CASCADE;
