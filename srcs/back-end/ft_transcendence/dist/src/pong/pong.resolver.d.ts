...
export declare class PongResolver {
    ...
    private minY;
    private speed;
    constructor(pongService: PongService, player: PlayerResolver, ball: BallResolver, waitingRoom: WaitingRoomResolver, user: UsersResolver, timer: TimerService);
    ...
    joinPongInvite(friendId: number, context: any): Promise<JoinPongResponse | {
    ...
    endPong(userId: number): Promise<string>;
