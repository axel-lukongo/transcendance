...
exports.WaitingRoomModule = WaitingRoomModule = __decorate([
    (0, common_1.Module)({
        providers: [waiting_room_resolver_1.WaitingRoomResolver, player_resolver_1.PlayerResolver, player_service_1.PlayerService, waiting_room_service_1.WaitingRoomService, prisma_service_1.PrismaService]
    })
], WaitingRoomModule);
