...
let AuthenticationResolver = exports.AuthenticationResolver = class AuthenticationResolver {
    ...
    async createUser(createAuthenticationInput) {
    ...
    async updateState(new_state, user_id, context) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_authentication_input_1.CreateAuthenticationInput]),
